...
async function main() {
  const { data, error } = await supabase.from('application_offers').select('*').in('application_id', ['ca8b0144-694c-452a-95ec-b92f356feaf5', '02947f7f-73fb-4eb7-8b48-32550d8a93d0'])
